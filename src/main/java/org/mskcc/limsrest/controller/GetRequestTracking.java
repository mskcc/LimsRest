...
public class GetRequestTracking {
    ...
    public Map<String,String> getContent(@RequestParam(value = "request") String requestId, HttpServletRequest request) {
        ...
        try {
            ...
            // GetRequestTrackingTask.SampleTrackingList sl = t.execute();
            return t.execute();
        } catch (Exception e) {
            log.error(e);
