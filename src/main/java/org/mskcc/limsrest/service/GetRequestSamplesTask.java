    ...
    public RequestSampleList execute() {
        try {
            ...
            for (DataRecord sample : samples) {
                ...
                String sampleStatus = sample.getStringVal("ExemplarSampleStatus", user);
                ...
                RequestSample rs = new RequestSample(othersampleId, igoId, igoComplete, sampleStatus);
                sampleList.add(rs);
            }
            ...
            rsl.setIlabRequestId(requestDataRecord.getStringVal("IlabRequest", user));
