    ...
    public Object execute(VeloxConnection conn) {
        ...
        try {
            ...
            for (DataRecord r : requestList) {
                GetSampleQcTask.annotateRequestSummary(rs, r, user);
                ...
                for (DataRecord qc : qcs) {
                    ...
                    SampleQcSummary qcSummary = GetSampleQcTask.annotateQcSummary(qc, user);
                    if (parentSample != null) {
                        GetSampleQcTask.annotateSampleSummary(ss, parentSample, user);
